...
const PostsCreateForm = ({token, setPosts}) => {
    ...
    return (<form className="ui form" onSubmit={async (event) => {
        ...
        <div className="field">
            ...
            <input name="location" type="text" className="field" placeholder="Title of Post" autoComplete="off" value={location} onChange={(event) => {setLocation(event.target.value);}}></input>
        </div>
